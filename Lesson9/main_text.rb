...
# проверка кода для поездов, вагонов, станций
...
# проверка модуля accessors

train1.a = 5
puts "Первое значение #{train1.a}"
train1.a = 10
puts "Второе значение #{train1.a}"
train1.a = 50
puts "Третье значение #{train1.a}"
puts "История значений: #{train1.a_history}"

train1.b = 54
puts "Первое значение #{train1.b}"
train1.b = 234
puts "Второе значение #{train1.b}"
train1.b = 56
puts "Третье значение #{train1.b}"
puts "История значений: #{train1.b_history}"
